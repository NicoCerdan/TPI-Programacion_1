...
def cargar_datos_csv(nombre_archivo): #creamos la funcion para majenar el archivo .cvs
    ...
    try:
        with open(nombre_archivo, newline='', encoding='utf-8') as archivo: # aca abrimos el archivo, newline controla los saltos de linea, encodig es el codigo que le dice a pytos que utilice el codigo de escritura adecuado para nuestro idioma
